"""Optimizer prompt templates as Python constants.

Used by graph/meeting_subgraph.py for direct LLM calls.
These match the prompts in prompts.md but are importable as strings.
"""
...
For each knowledge graph learning, output this JSON structure:
{{"agent_target": "<strategist|risk_strategist|analyst|all>", "category": "<regime_detection|signal_quality|position_sizing|timing|risk_sizing>", "regime": "<trending|ranging|high_volatility|all>", "applies_to": "<intraday|swing|options|all>", "learning": "<specific actionable sentence>", "confidence": <0.0-1.0>}}
